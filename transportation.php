...
<!--Page Header-->
<section id="Transportation-page-header" class="text-light text-center mb-5">
  <div class="container">
    <div class="row">
      <div class="col pt-5">
        <h2 class="text-light">Transportation Services</h2>
        <p class="lead">Check Out Our Transportation</p>
      </div>
    </div>
  </div>
</section>
...
<?php
global $connectingdb;
$sql = "SELECT *FROM client WHERE type='transportation'";
