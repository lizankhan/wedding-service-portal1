...
<section id="catering" class="py-3 ">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-4">
        <img src="img/catering/baby-shower-birthday-buffet-587741.jpg" class="img-fluid rounded" alt="image">
      </div>
      <div class="col-md-8 ">

        <h3> <?php echo $row['name']; ?> </h3>
        <p class="lead">Contact us:</p>
        <p class="lead">Email: <?php echo $row['email']; ?></p>
        <p class="lead">Phone: <?php echo $row['phone']; ?>  </p>
